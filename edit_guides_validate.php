...
<head>
    ...
    <title>Edit Guides validate</title>
...
$sql ="UPDATE guides SET title='$sanitisedTitle', description='$sanitisedDescription', content='$sanitisedPost' , picture='$target_file' WHERE id = $id";
?>

<?php
if ($conn->query(query: $sql) === TRUE) {
    echo "<h1>New record created successfully</h1>";
    echo "<a class=btn href='listguides.php'>Back to Guides</a>";
} else{
