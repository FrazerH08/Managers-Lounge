...
$SQL = "DELETE FROM discussion_board WHERE id =" . $_GET['id'];
...
<body>
    ...
    if ($result === TRUE) {
        echo "<h1 class='title'>Thread Deleted Successfully</h1>";
        echo "<p style='display:block; text-align:center;'>" . mysqli_affected_rows($conn) ." Rows Affected </p>";
        echo "<p style='display:block; text-align:center;'><a class=btn href='discussionboard.php'>Back To Discussion Board </a></p>";
    } else {
